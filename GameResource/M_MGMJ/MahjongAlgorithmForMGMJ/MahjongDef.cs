...
namespace MahjongAlgorithmForMGMJ
{
    public class MGMJConstants
    {
        ...
        /// 游戏ID
        /// </summary>
        public const int WHMJ_GAMEID = 102;
        /// <summary>
        /// AI用户ID
        /// </summary>
        ...
        /// 游戏名称
        /// </summary>
        public const string GAME_NAME = "明光麻将";
        /// <summary>
        /// 游戏版本号
        /// </summary>
    ...
    public class clsDissTable
    {
        ...
        public clsDissTable()
        {
            _playerVote = new byte[MGMJConstants.GAME_PLAYER];
            clear();
        }
        ...
        public void clear()
        {
            ...
            Array.Clear(this._playerVote, 0, MGMJConstants.GAME_PLAYER);
        }
