...
namespace MahjongAlgorithmForLHZMJ
{
    public class LHZMJConstants
    {
        ...
        /// 游戏ID
        /// </summary>
        public const int WHMJ_GAMEID = 101;
        /// <summary>
        /// AI用户ID
        /// </summary>
        ...
        /// 游戏名称
        /// </summary>
        public const string GAME_NAME = "红中麻将";
        /// <summary>
        /// 游戏版本号
        /// </summary>
        ...
        /// 牌包数量
        /// </summary>
        public const int gCardCount_Package = 112;
    }
    /// <summary>
    /// 麻将常量定义
    /// </summary>
    ...
    public class MahjongDef
    {
        ...
        /// 真人思考时间
        /// </summary>
        public const int gTrueManWaitSecond = 5;
        /// <summary>
        /// 换牌张数
        /// </summary>
        ...
        /// 投票权限掩码:听
        /// </summary>
        public const byte gVoteRightMask_Ting = 0x05;
        ...
        /// 投票结果:听
        /// </summary>
        public const byte gVoteResult_Ting = 4;
        /// <summary>
        /// 无投票操作
        /// </summary>
    ...
    public class clsFixedCard
    {
        ...
        public void Add(byte cbCard, byte outchair, enFixedCardType type, bool giveUpGang2Peng = false)
        {
        ...
        public clsFixedCard CopyFrom(ref clsFixedCard src)
        {
            ...
            {
                this.Add(fixedCard.card, fixedCard.outChair, fixedCard.fixedType, fixedCard.isGiveUpGang2Peng);
            }
            return this;
        }
    };
    ...
    public class clsPlayerCard
    {
        ...
        public List<byte> flowerCard = new List<byte>();
        /// <summary>
        /// 听牌
        /// </summary>
    ...
    public class clsParseResult
    {
        ...
        /// 是否是素牌
        /// </summary>
        public bool isSuPai { get; set; }
        /// <summary>
        /// 是否是捧手
        /// </summary>
        public bool isSiZhong { get; set; }
        /// <summary>
        /// 胡的牌
        /// </summary>
    ...
    public class clsDissTable
    {
        ...
        public clsDissTable()
        {
            _playerVote = new byte[LHZMJConstants.GAME_PLAYER];
            clear();
        }
        ...
        public bool playerVote(byte chair, byte vote)
        {
            ...
            byte temp = 0;
            foreach (var i in this._playerVote)
            {
                if (1 != i)
                {
                    return false;
            ...
            if(temp < LHZMJConstants.GAME_PLAYER - 1)
            {
                return false;
            }
            return true;
        ...
        public void clear()
        {
            ...
            Array.Clear(this._playerVote, 0, LHZMJConstants.GAME_PLAYER);
        }
