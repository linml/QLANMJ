...
namespace M_LHZMJ
{
    ...
    public class clsTableRule
    {
        ...
        /// 杠了就有
        /// </summary>
        public bool IsGangJiuYou { get; set; }
        ...
        public bool is4hui { get; set; }
        public bool is7hui { get; set; }
        public bool isM1A2 { get; set; }
        public bool isM3A4 { get; set; }
        public bool isChuHunJiaFan { get; set; }
        public bool ifCanHu7Dui { get; set; }
        public bool ifCanTianHu { get; set; }
        public bool IfCanBaoTing { get; set; }

        public bool CheckGps { get; set; }

        public bool GuoHuBuHu { get; set; }

        public byte MaShu { get; set; }
        public byte RulePeng { get; set; }
        public byte OutCardTime { get; set; }
        ...
        ///// <summary>
        ///// 宿州麻将，将底作为时长计算，所以新增真实局数，以前的局数作为底数使用，新的一底，从零开始
        ///// </summary>
        ...
        public bool isPlayEnoughGameNum
        {
            ...
            {
                //设置的局数
                return this._gameNum >= this._setGameNum;
            }
        }
        /// <summary>
        /// 是否有效
