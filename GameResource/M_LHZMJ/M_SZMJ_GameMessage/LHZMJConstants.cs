...
namespace M_LHZMJ_GameMessage
{
    ...
    public class LHZMJMsgID_c2s
    {
        ...
        /// 补花
        /// </summary>
        public const byte CMD_C_BuHua = 31;

        public const byte CMD_C_NoZiMo = 32;
        public const byte CMD_C_NoGang = 33;
    }
    ...
    public class LHZMJMsgID_s2c
    {
        ...
        /// 补花
        /// </summary>
        public const byte CMD_S_BuHua = 161;
        ...
        /// 这局的花牌列表
        /// </summary>
        public const byte CMD_S_FlowerCardAry = 163;
        #region 断线重连
