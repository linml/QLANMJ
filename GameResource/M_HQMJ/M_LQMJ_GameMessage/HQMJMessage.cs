...
namespace M_HQMJ_GameMessage
{
    ...
    /// 游戏开始
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_Start)]
    ...
    /// 当前活动玩家
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ActivePlayer)]
    ...
    /// 客户端开始发牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_StartSendCard)]
    ...
    /// 玩家断线
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerOffline)]
    ...
    /// 色子及庄家信息
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_SZInfo)]
    ...
    /// 游戏ID
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_GameID)]
    ...
    /// 初始化牌阵
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_InitCard)]
    ...
    /// 翻开混牌阶段
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_FanKaiHun)]
    ...
    /// 一玩家打出牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerOutCard)]
    ...
    /// 玩家抓牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerHoldCard)]
    ...
    /// 玩家豹听
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerBaoTing)]
    ...
    /// 玩家暗杠牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerAnGangCard)]
    ...
    /// 玩家补杠牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerBuGangCard)]
    ...
    /// 玩家明杠牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerMingGang)]
    ...
    /// 抢杠
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_QiangGang)]
    ...
    /// 玩家吃牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerChiCard)]
    ...
    /// 玩家碰牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerPengCard)]
    ...
    /// 玩家豹听
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerBao)]
    ...
    /// 玩家胡牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerHuCard)]
    ...
    /// 当前操作的真人玩家操作权限等等
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_OpPlayer)]
    ...
    /// 玩家投票权限
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_VoteRight)]
    ...
    /// 玩家牌阵
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerCardData)]
    ...
    /// 结算信息
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_Balance)]
    ...
    /// 桌子配置
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_TableConfig)]
    ...
    /// 手牌数据
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_HandCardData)]
    ...
    /// 删除抢杠牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_DelQiangGangCard)]
    ...
    /// 强退成功
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ForceLeftSuccess)]
    ...
    /// 创建桌子成功
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_CreateTableSuccess)]
    ...
    /// 开始创建桌子
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_StartCreateTable)]
    ...
    /// 房主信息
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_TableCreatorInfo)]
    ...
    /// 强制玩家离开
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ForceUserLeft)]
    ...
    /// 显示提示消息
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ShowMsg)]
    ...
    /// 好友求助信息
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_FriendHelpInfo)]
    ...
    /// 好友拒绝资助
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_FriendReject)]
    ...
    /// 好友资助成功
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_FriendHelpSuccess)]
    ...
    /// 游戏记录结果
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_GameRecordResult)]
    ...
    /// 游戏记录结果
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_QuitCreator)]
    ...
    /// 新的游戏回合
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_NewGameRound)]
    ...
    /// 抢杠结果
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_VoteQGResult)]
    ...
    /// 玩家余额
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerMoney)]
    ...
    /// 有玩家申请解散房间
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerDissTable)]
    ...
    /// 玩家投票解散房间
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerVoteDissTable)]
    ...
    /// 解散房间成功
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_DissTableSuccess)]
    ...
    ///// 海底捞时间
    ///// </summary>
    //[PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_HaiDiLaoTime)]
    ...
    ///// 报警
    ///// </summary>
    //[PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_BaoJing)]
    ...
    /// 玩家准备
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_UseReady)]
    ...
    /// 保留桌子成功
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_SaveTableSuccess)]
    ...
    /// 删除玩家牌池牌牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_DelPoolCard)]
    ...
    /// 开始跑
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_StartPao)]
    ...
    /// 开始拉
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_StartLa)]
    ...
    /// 自己的跑
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_SelfPao)]
    ...
    /// 自己的拉
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_SelfLa)]
    ...
    /// 自己的跑
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerPaoInfo)]
    ...
    /// 自己的拉
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_PlayerLaInfo)]
    ...
    /// 断线重连游戏信息
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ORC_GameInfo)]
    ...
    /// 断线重连玩家牌阵
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ORC_PlayerCard)]
    ...
    /// 断线重连恢复投票阶段
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ORC_Vote)]
    ...
    /// 断线重连结束
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ORC_Over)]
    ...
    /// 断线重连恢复胡解散房间
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ORC_DissTable)]
    ...
    /// 断线重连,玩家分数变化
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_ORC_GameScoreChange)]
    ...
    /// 玩家抓牌结束
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_HoldCardComplete)]
    ...
    /// 玩家自摸
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_ZiMo)]
    ...
    /// 玩家杠
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_Gang)]
    ...
    /// 玩家吃
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_Chi)]
    ...
    /// 玩家打出牌
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_OutCard)]
    ...
    /// 玩家投票
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_Vote)]
    ...
    /// 玩家抢杠
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_QiangGang)]
    ...
    /// 请求强退
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_ForceLeft)]
    ...
    /// 创建桌子
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_CreateTable)]
    ...
    /// 操作频繁
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_IsDissolution)]
    ...
    /// 向好友求助
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_FriendHelp)]
    ...
    /// 拒绝帮助好友
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_RejectHelp)]
    ...
    /// 确认帮助好友
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_HelpFriend)]
    ...
    /// 查询游戏记录
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_QueryGameRecord)]
    ...
    /// 玩家申请解散房间
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_OfferDissTable)]
    ...
    /// 投票解散房间
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_VoteDissTable)]
    ...
    /// 玩家准备下一局
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_NextGame)]
    ...
    /// 玩家准备下一局
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_ReSetScene)]
    ...
    /// 保留桌子
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_SaveTable)]
    ...
    /// 玩家跑
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_Pao)]
    ...
    /// 玩家豹听
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_BaoTing)]
    ...
    /// 玩家放弃豹听
    /// </summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_c2s.CMD_C_GiveUpBaoTing)]
    ...
    ///听牌椅子号
    ///</summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_Ting)]
    ...
    ///听牌椅子号
    ///</summary>
    [PacketContract(((byte)HQMJConstants.WHMJ_GAMEID) << 8 | (byte)HQMJMsgID_s2c.CMD_S_Version)]
