...
const { ccclass, property } = cc._decorator;
    ...
    export interface IMGMJClass {
        ...
        getTableConfig():MGMJTableConfig;
    ...
    export class MGMJ{
        ...
        private static _ins:MGMJ=null;
        private _icalss:IMGMJClass=null;
        private _iview:IMGMJView=null;
         ...
         * 逻辑
         * */
        public get iclass():IMGMJClass{
            return this._icalss;
        }
        public set iclass(value:IMGMJClass){
            this._icalss = value;
        }
         ...
         * 视图
         * */
        public get iview():IMGMJView{
            return this._iview;
        }
        public set iview(value:IMGMJView){
            this._iview = value;
        }
    }


	export class MGMJMahjongDef {

        public static gameID:number=102;
     ...
     * */
     ...
     export class MGMJTableConfig{
        ...
        public constructor(){    
            ...
            this._tableCreatorChair = MGMJMahjongDef.gInvalidChar;
            this._tableCode = "";
            this._setGameNum=1;
        ...
        public get cellScore():number{
            if(MGMJ.ins.iclass.isCreateRoom()){
                return this._cellScore;
                       ...
                       if(MGMJ.ins.iclass.getRoomData()){
                return MGMJ.ins.iclass.getRoomData().BaseMoney;
            }
            else{
    ...
    export class MGMJTimer{
        ...
        public clear():void{
            ...
            this._curTime=0;
            this._triggerTime=0;
            this._chair = MGMJMahjongDef.gInvalidChar;
     ...
     * 合肥麻将打牌玩家
     * */
    export class MGMJOutCardPlayer{
        private _chair:number;
         ...
         * */
        public get isValid():boolean{
            if((MGMJMahjongDef.gInvalidChar != this._chair) && (MGMJMahjongDef.gInvalidMahjongValue != this._card)){
                return true;
            }
            return false;
        }
        ...
        public clear():void{
            this._chair = MGMJMahjongDef.gInvalidChar;
            this._card = MGMJMahjongDef.gInvalidMahjongValue;
        }
    }
    ...
    export class MGMJRecordCard{
        ...
        public getCardLeftNum(card:number,checkAry:Array<number> = null):number{
            var logicValue: number = MGMJMahjongAlgorithm.GetMahjongLogicValue(card);
    ...
    export class clsParseTriple
    {
        ...
        public Clear():void
        {
            this.cTokenCard = MGMJMahjongDef.gInvalidMahjongValue;
        ...
        public GetTokenNum():number
        {
            ...
            return (wBaseNum + MGMJMahjongAlgorithm.GetMahjongLogicValue(this.cTokenCard));
        }
        ...
        public get isValid():boolean
        {
                if ((MGMJMahjongDef.gInvalidMahjongValue != this.cTokenCard) && (enTripleType.TripleType_Unknown != this.enTripleType)){
                    return true;
                }
                return false;
        }
   ...
   /// <summary>
    ...
    export class clsNormalParseStruct
    {
        ...
        public Clear():void
        {
            this.pair = MGMJMahjongDef.gInvalidMahjongValue;
        ...
        public get isValid():boolean
        {
            ...
            return this.pair != MGMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsParseResult
    {
        ...
        public Clear():void
        {
            this.isValid = false;
            this.is7Pair = false;
            this.huCard = MGMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsSingleFixedCard
    {
	    ...
	    public Clear():void
	    {
            this.card = MGMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsPairTripleWrapper
    {
        ...
        public Clear():void
        {
            this.cPair = MGMJMahjongDef.gInvalidMahjongValue;
            this.wTripleCount = 0;
