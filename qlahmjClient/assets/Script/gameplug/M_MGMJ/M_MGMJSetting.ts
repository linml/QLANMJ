...
@ccclass
export default class M_MGMJSetting extends CreateRoomSettingBase {
    public GetSetting() {
    ...
    private Init(): void {
       ...
       const tempdata=new M_MGMJ_GameData();
    ...
    private onCreateTable(): CreateRoomStruct {
        const createTable = new M_MGMJ_GameData();
      ...
      //  this.SetItem("qiang",this.cbx_qiang.isChecked?"1":"0");
        ...
        createTable.setPlayerNum=4;
        createTable.waitTimeNum=0;
