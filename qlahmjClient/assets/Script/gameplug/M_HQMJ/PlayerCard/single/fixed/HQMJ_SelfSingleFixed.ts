        ...
        if(_hqmj.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    // url=this._hqmjClass.getMahjongResName(this.cardValue);
                    // SetTextureRes(url,this.bmp_cardcolorAry[1]);
                    this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                    this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_backcard_self_1280");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                    this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_self_1280");
            ...
            switch(this.fixedType) {
                ...
                case enFixedCardType.FixedCardType_Peng: {                  
                    ...
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_self_1_6");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_self_1_5");
                        //this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_self_1280");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
