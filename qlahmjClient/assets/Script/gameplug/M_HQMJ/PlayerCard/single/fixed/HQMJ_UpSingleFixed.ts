...
@ccclass
export default class HQMJ_UpSingleFixed extends HQMJ_SingleFixedBase {
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {                 
                    ...
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_17");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_15");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_16");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_14");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_12");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_13");
                        this.bmp_cardcolorAry[3].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_11");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_9");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_10");
                        this.bmp_cardcolorAry[3].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_8");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_2_6");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_7");
                        this.bmp_cardcolorAry[3].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_MGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_17");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_15");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_14");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_12");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_11");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_9");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_8");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_6");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_left_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
