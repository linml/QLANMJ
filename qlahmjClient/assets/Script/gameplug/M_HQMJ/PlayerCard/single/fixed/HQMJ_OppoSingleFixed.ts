...
@ccclass
export default class HQMJ_OppoSingleFixed extends HQMJ_SingleFixedBase {
    onLoad() {
        // init logic
        ...
        if(_hqmj.is2D()){
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
                    this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
                    this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcardback_oppo_self_1280");
                    this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    ...
                    this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
                    this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
                    this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
                    this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjongPaiBeiRes("pb3_showcard_oppo_1280");
            ...
            switch(this.fixedType) {
                case enFixedCardType.FixedCardType_AGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_15");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_16");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_17");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_12");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_13");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_14");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_13");
                        this.bmp_cardcolorAry[3].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else if(this._cardIndex==3){
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_9");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_10");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_11");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_10");
                        this.bmp_cardcolorAry[3].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else if(this._cardIndex==4){
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_6");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_7");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_2_8");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_7");
                        this.bmp_cardcolorAry[3].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[3].node.scaleX = 0.4;
                        this.bmp_cardcolorAry[3].node.scaleY = 0.38;
                    }else{
                ...
                case enFixedCardType.FixedCardType_BGang: {
                    if(this._cardIndex==1){
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_15");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_17");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_12");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_13");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_14");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_13");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_9");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_10");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_11");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_10");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        ...
                        this.bmp_cardbackAry[0].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_6");
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_7");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_8");
                        this.bmp_cardbackAry[3].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_7");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue);
                ...
                case enFixedCardType.FixedCardType_Chi: {                   
                    if(this._cardIndex==1){
                        ...
                        this.bmp_cardbackAry[1].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_16");
                        this.bmp_cardbackAry[2].spriteFrame=_hqmj.getMahjong3DPaiBeiRes("chi_oppo_1_17");
                        this.bmp_cardcolorAry[0].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType);
                        this.bmp_cardcolorAry[1].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType -1);
                        this.bmp_cardcolorAry[2].spriteFrame=_hqmj.getMahjongPaiHuaRes(this.cardValue + this._chiType -2);
