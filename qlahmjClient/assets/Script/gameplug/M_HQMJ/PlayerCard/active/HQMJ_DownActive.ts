...
@ccclass
export default class HQMJ_DownActive extends HQMJ_OtherActive {
    ...
    protected refreshHandCard(): void {
        ...
        if(_hqmj.is2D()){
            ...
            if(this.isLie){
                //起始位置
                let startPos: number = HQMJ_DownActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                ...
                //起始位置
                let startPos: number = HQMJ_DownActive.ArrangeStartPos3D_stand[this.fixedCardNum];
