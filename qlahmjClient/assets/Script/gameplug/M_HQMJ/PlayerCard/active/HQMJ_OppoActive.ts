...
@ccclass
export default class HQMJ_OppoActive extends HQMJ_OtherActive {
    ...
    //
        ...
        if(_hqmj.is2D()){
            if(this.isLie) {
                ...
                //起始位置
                var startPos: number = HQMJ_OppoActive.ArrangeStartPos_stand[this.fixedCardNum];
            ...
            if(this.isLie) {
            //起始位置
                let startPos: number = HQMJ_OppoActive.ArrangeStartPos3D_lie[this.fixedCardNum];
                //this.resetZ();
                ...
                //起始位置
                let startPos: number = HQMJ_OppoActive.ArrangeStartPos3D_stand[this.fixedCardNum];
