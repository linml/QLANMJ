...
import { allZhi } from "../ConstDef/HQMJMahjongDef";
import { enTinType, enFixedCardType } from "../ConstDef/HQMJMahjongDef";
import M_HQMJView from "../M_HQMJView";

const { ccclass, property } = cc._decorator;

	export class HQMJMahjongAlgorithm {
        ...
        public static GetMahjongColor(card:number):number{
            return (card & HQMJMahjongDef.gCardMask_color) >> 4;
        }
        /**
         * 取花色数值,0x00万,0x10筒,0x20条
         * */
        public static GetMahjongColorValue(card:number):number{
            return (card & HQMJMahjongDef.gCardMask_color);
        }
        /**
         * 取麻将牌值,1~9,一万==一筒==一条
         * */
        public static GetMahjongValue(card):number{
            return (card & HQMJMahjongDef.gCardMask_value);
        }
        /**
         * 取麻将牌逻辑数值,取牌逻辑值:万<筒<条<字<花
         * */
        public static GetMahjongLogicValue(card):number{
            return HQMJMahjongAlgorithm.GetMahjongColor(card) * 10 + HQMJMahjongAlgorithm.GetMahjongValue(card);
        }
        ...
        public static CheckVoteRight_Chi(voteRight:number):boolean{
            return (voteRight & HQMJMahjongDef.gVoteRightMask_Chi) > 0;
        }
        /**
         * 检查是否可以碰
         * */
        public static CheckVoteRight_Peng(voteRight:number):boolean{
            return (voteRight & HQMJMahjongDef.gVoteRightMask_Peng) > 0;
        }
        /**
         * 检查是否可以杠
         * */
        public static CheckVoteRight_Gang(voteRight: number): boolean {
            return (voteRight & HQMJMahjongDef.gVoteRightMask_Gang) > 0;
        }
        /**
         * 检查是否可以豹
         * */
        public static CheckVoteRight_Bao(voteRight:number):boolean{
            return (voteRight & HQMJMahjongDef.gVoteRightMask_Bao) > 0;
        }
        /**
         * 检查是否可以胡
         * */
        public static CheckVoteRight_Hu(voteRight: number): boolean {
            return (voteRight & HQMJMahjongDef.gVoteRightMask_Hu) > 0;
        }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == HQMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(HQMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(HQMJMahjongAlgorithm.GetMahjongColor(handCard[i])){
                        case HQMJMahjongDef.gMahjongColor_Wan:{
                            if(null != wan){
                                wan.push(handCard[i]);
                            }
                            break;
                        }
                        case HQMJMahjongDef.gMahjongColor_Tong:{
                            if(null != tong){
                                tong.push(handCard[i]);
                            }
                            break;
                        }
                        case HQMJMahjongDef.gMahjongColor_Tiao:{
                            if(null != tiao){
                                tiao.push(handCard[i]);
                            }
                            break;
                        }
                        case HQMJMahjongDef.gMahjongColor_Zhi:{
                            if(null != zhi){
                                zhi.push(handCard[i]);
                            }
                        }
        ...
        public static GetLastCardToTing(srcAry:Array<number>):Array<number>{       
            ...
            //不排序，排序会打乱对应
            //HQMJMahjongAlgorithm.sortCardAry(vectorChuCard);
        }
        /**
		 * 检查是否听牌
		 */
        public static CheckIfCanTingCardArray(srcAry:Array<number>):Boolean{
            ...
            for(var i:number=0;i<srcAry.length;i++)
            {
                if(HQMJMahjongDef.gInvalidMahjongValue!=srcAry[i])
                    cardAry.push(srcAry[i]);
            }
            if(1 != (cardAry.length % 3)) {
                return false;
            }
            HQMJMahjongAlgorithm.sortCardAry(cardAry);
     ...
     */
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            HQMJMahjongAlgorithm.spiltHandCard(handCard, vWanCard, vTongCard, vTiaoCard, vZhiCard);
        ...
        private static CheckIfTingSevenPair(vSrc:Array<number>):boolean{
            ...
            HQMJMahjongAlgorithm.sortCardAry(vSrc);
        ...
        public static GetTwo2ModelTinCards(vectorCard1: Array<number>,vectorCard2: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard1[0]) < HQMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
            ...
            if(this.GetMahjongColor(vectorCard2[0]) < HQMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
        ...
        public static Get2ModelTinCards(vectorCard: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard[0]) < HQMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //2张
                if(vectorCard.length == 2) {
        ...
        public static Get1ModelTinCards(cardVector: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(cardVector[0]) < HQMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //1张
