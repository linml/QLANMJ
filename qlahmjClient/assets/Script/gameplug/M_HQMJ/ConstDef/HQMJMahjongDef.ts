...
const { ccclass, property } = cc._decorator;
    ...
    export interface IHQMJClass {
        ...
        getTableConfig():HQMJTableConfig;
    ...
    export class HQMJ{
        ...
        private static _ins:HQMJ=null;
        private _icalss:IHQMJClass=null;
        private _iview:IHQMJView=null;
         ...
         * 逻辑
         * */
        public get iclass():IHQMJClass{
            return this._icalss;
        }
        public set iclass(value:IHQMJClass){
            this._icalss = value;
        }
         ...
         * 视图
         * */
        public get iview():IHQMJView{
            return this._iview;
        }
        public set iview(value:IHQMJView){
            this._iview = value;
        }
    }


	export class HQMJMahjongDef {

        public static gameID:number=100;
        /// <summary>
        /// 花色掩码
        /// </summary>
    ...
    export class HQMJTableConfig{
        ...
        public constructor(){    
            ...
            this._tableCreatorChair = HQMJMahjongDef.gInvalidChar;
            this._tableCode = "";
            this._setGameNum=1;
        ...
        public get cellScore():number{
            if(HQMJ.ins.iclass.isCreateRoom()){
                return this._cellScore;
                       ...
                       if(HQMJ.ins.iclass.getRoomData()){
                return HQMJ.ins.iclass.getRoomData().BaseMoney;
            }
            else{
    ...
    export class HQMJTimer{
        ...
        public clear():void{
            ...
            this._curTime=0;
            this._triggerTime=0;
            this._chair = HQMJMahjongDef.gInvalidChar;
     ...
     * 合肥麻将打牌玩家
     * */
    export class HQMJOutCardPlayer{
        private _chair:number;
         ...
         * */
        public get isValid():boolean{
            if((HQMJMahjongDef.gInvalidChar != this._chair) && (HQMJMahjongDef.gInvalidMahjongValue != this._card)){
                return true;
            }
            return false;
        }
        ...
        public clear():void{
            this._chair = HQMJMahjongDef.gInvalidChar;
            this._card = HQMJMahjongDef.gInvalidMahjongValue;
        }
    }
    ...
    export class HQMJRecordCard{
        ...
        public getCardLeftNum(card:number,checkAry:Array<number> = null):number{
            var logicValue: number = HQMJMahjongAlgorithm.GetMahjongLogicValue(card);
    ...
    export class clsParseTriple
    {
        ...
        public Clear():void
        {
            this.cTokenCard = HQMJMahjongDef.gInvalidMahjongValue;
        ...
        public GetTokenNum():number
        {
            ...
            return (wBaseNum + HQMJMahjongAlgorithm.GetMahjongLogicValue(this.cTokenCard));
        }
        ...
        public get isValid():boolean
        {
                if ((HQMJMahjongDef.gInvalidMahjongValue != this.cTokenCard) && (enTripleType.TripleType_Unknown != this.enTripleType)){
                    return true;
                }
                return false;
        }
   ...
   /// <summary>
    ...
    export class clsNormalParseStruct
    {
        ...
        public Clear():void
        {
            this.pair = HQMJMahjongDef.gInvalidMahjongValue;
        ...
        public get isValid():boolean
        {
            ...
            return this.pair != HQMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsParseResult
    {
        ...
        public Clear():void
        {
            this.isValid = false;
            this.is7Pair = false;
            this.huCard = HQMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsSingleFixedCard
    {
	    ...
	    public Clear():void
	    {
            this.card = HQMJMahjongDef.gInvalidMahjongValue;
    ...
    export class clsPairTripleWrapper
    {
        ...
        public Clear():void
        {
            this.cPair = HQMJMahjongDef.gInvalidMahjongValue;
            this.wTripleCount = 0;
