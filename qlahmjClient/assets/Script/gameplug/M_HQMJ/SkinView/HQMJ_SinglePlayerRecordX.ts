...
@ccclass
export default class HQMJ_SinglePlayerRecordX extends cc.Component {
    ...
    //数据
    private _data: M_HQMJ_GameMessage.GameRecordResult;
    //索引
    private _idx:number;
    ...
    public init(data: M_HQMJ_GameMessage.GameRecordResult,idx:number) {
        this._data = data;
        this._idx = idx;
        this.setData();
    }
