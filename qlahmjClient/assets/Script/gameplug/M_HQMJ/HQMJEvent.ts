...
export default class HQMJEvent extends cc.Event.EventCustom {


    /**
         * 消息标识
         * */
        public static HQMJ_EVENT_TYPE: string = "event_hnmj_event_type";
        ...
        public constructor(msgCode: number,parm?: any,data?: any) {
            ...
            super(HQMJEvent.HQMJ_EVENT_TYPE,true);
         ...
         * 克隆一个
         * */
        public clone(): HQMJEvent {
            return new HQMJEvent(this._msgCode,this._parm,this.getUserData());
        }
}
