...
import { allZhi } from "../ConstDef/HZMJMahjongDef";
import { enTinType, HZMJ,enFixedCardType, clsParseTriple, enHuCardType, enTripleType } from "../ConstDef/HZMJMahjongDef";
import M_HZMJView from "../M_HZMJView";
import { HZMJMahjongPattern } from "./HZMJMahjongPattern";
import M_HZMJClass from "../M_HZMJClass";

const { ccclass, property } = cc._decorator;

	export class HZMJMahjongAlgorithm1 {
        ...
        public static GetTwo2ModelTinCards(vectorCard1: Array<number>,vectorCard2: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard1[0]) < HZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
            ...
            if(this.GetMahjongColor(vectorCard2[0]) < HZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
        ...
        public static Get2ModelTinCards(vectorCard: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard[0]) < HZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //2张
                if(vectorCard.length == 2) {
        ...
        public static Get1ModelTinCards(cardVector: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(cardVector[0]) < HZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //1张
    	...
    	public static getNeedChangeCard(handCard:Array<number>):Array<number>{
            ...
            if((null == handCard) || (handCard.length < 3)) {
    	      ...
    	      HZMJMahjongAlgorithm1.spiltHandCard(handCard,wanCardAry,tongCardAry,tiaoCardAry,null);
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            HZMJMahjongAlgorithm1.spiltHandCard(handCard,vWanCard,vTongCard,vTiaoCard,vZhiCard);

            //检查万筒条是否满足条件
            if (!HZMJMahjongPattern.CheckValueBiggerTwo(vWanCard) || !HZMJMahjongPattern.CheckValueBiggerTwo(vTongCard) || !HZMJMahjongPattern.CheckValueBiggerTwo(vTiaoCard))
            {
                return false;
            }

            //检查字是否满足条件
            if (!HZMJMahjongPattern.CheckZhiIsSame(vZhiCard))
            {
                return false;
            }
        ...
        //////////////////////////////////////////////////////////////////egret安庆麻将中的HZMJMahjongAlgorithm1里面的代码//////////////////////////////////////////////////
        ...
        public static getColorNum(handCard: Array<number>):number{
            ...
            for(var i = 0;i < handCard.length; i++) {
                if(HZMJMahjongDef.gInvalidMahjongValue == handCard[i]){
                    continue;
                }
                colorCard[HZMJMahjongAlgorithm1.GetMahjongColor(handCard[i])] = 1;
            }
        ...
        public static CheckIsJiangCard(checkCard: number): boolean {
            if(HZMJMahjongDef.gMahjongColor_Zhi == HZMJMahjongAlgorithm1.GetMahjongColor(checkCard)) {
                return false;
            }

            if((2 == HZMJMahjongAlgorithm1.GetMahjongValue(checkCard)) ||
                (5 == HZMJMahjongAlgorithm1.GetMahjongValue(checkCard)) ||
                (8 == HZMJMahjongAlgorithm1.GetMahjongValue(checkCard))) {
                return true;
            }
        ...
        public static CheckIs19Card(checkCard: number): boolean {
            ...
            if((1 == HZMJMahjongAlgorithm1.GetMahjongValue(checkCard)) ||
                (9 == HZMJMahjongAlgorithm1.GetMahjongValue(checkCard))) {
                return true;
            }
        ...
        public static GetMahjongColor(card:number):number{
            return (card & HZMJMahjongDef.gCardMask_color) >> 4;
        }
        /**
         * 取花色数值,0x00万,0x10筒,0x20条，0x30字
         * */
        public static GetMahjongColorValue(card:number):number{
            return (card & HZMJMahjongDef.gCardMask_color);
        }
        /**
         * 取麻将牌值,1~9,一万==一筒==一条
         * */
        public static GetMahjongValue(card):number{
            return (card & HZMJMahjongDef.gCardMask_value);
        }
        /**
         * 取麻将牌逻辑数值,取牌逻辑值:万<筒<条<字<花
         * */
        public static GetMahjongLogicValue(card):number{
            return HZMJMahjongAlgorithm1.GetMahjongColor(card) * 10 + HZMJMahjongAlgorithm1.GetMahjongValue(card);
        }
        ...
        public static CheckVoteRight_Peng(voteRight:number):boolean{
            return (voteRight & HZMJMahjongDef.gVoteRightMask_Peng) > 0;
           //return (voteRight == HZMJMahjongDef.gVoteRightMask_Peng);
        }
        /**
         * 检查是否可以杠
         * */
        public static CheckVoteRight_Gang(voteRight: number): boolean {
            return (voteRight & HZMJMahjongDef.gVoteRightMask_Gang) > 0;
         // return (voteRight == HZMJMahjongDef.gVoteRightMask_Gang);
        }
        /**
         * 检查是否可以胡
         * */
        public static CheckVoteRight_Hu(voteRight: number): boolean {
            return (voteRight & HZMJMahjongDef.gVoteRightMask_Hu) > 0;
         // return (voteRight == HZMJMahjongDef.gVoteRightMask_Hu);
        }
         /**
         * 检查是否可以听
         * */
        public static CheckVoteRight_Ting(voteRight: number): boolean {
            ...
            return (voteRight == HZMJMahjongDef.gVoteRightMask_Ting);
        ...
        //     return (voteRight & HZMJMahjongDef.gVoteRightMask_Chi) > 0;
        // }
        ...
        public static sortCardAry(cardAry:Array<number>):void{
            ...
            //         if(cardAry[i]!=HZMJMahjongDef.LaiZi&&(cardAry[j]==HZMJMahjongDef.LaiZi||cardAry[i] > cardAry[j])){
...
// }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == HZMJMahjongAlgorithm1.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        */
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(HZMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(HZMJMahjongAlgorithm1.GetMahjongColor(handCard[i])){
                        case HZMJMahjongDef.gMahjongColor_Wan:{
                            if(null != wan){
                                wan.push(handCard[i]);
                            }
                            break;
                        }
                        case HZMJMahjongDef.gMahjongColor_Tong:{
                            if(null != tong){
                                tong.push(handCard[i]);
                            }
                            break;
                        }
                        case HZMJMahjongDef.gMahjongColor_Tiao:{
                            if(null != tiao){
                                tiao.push(handCard[i]);
                            }
                            break;
                        }
                        case HZMJMahjongDef.gMahjongColor_Zhi:{
                            if(null != zhi){
                                zhi.push(handCard[i]);
                            }
                        }
        ...
        public static IsHunYiSe(Ary:Array<number>):boolean{
            ...
            var colorfirst = HZMJMahjongDef.gInvalidMahjongValue;
        ...
        public static CheckIfCanTingCardArray(srcAry:Array<number>,laizi:number):Boolean{
            ...
            for(var i:number=0;i<srcAry.length;i++)
            {
                if(HZMJMahjongDef.gInvalidMahjongValue!=srcAry[i])
        ...
        public static GetTingCardArrayHaveHun(srcAry:Array<number>,laizi:number):Array<number>{
            ...
            for (var i = 0; i < HZMJMahjongDef.gMahjongCard.length; i++)
            {
                if(this.GetCardNumInCardAry(srcAry,HZMJMahjongDef.gMahjongCard[i])==4){//这个判断是，如果手上有4张牌则不提示胡此牌
                    continue;
                }
                ...
                var flower:Array<number> =HZMJMahjongAlgorithm1.GetFlowerCardAryHZMJ();//手上有花牌不能胡
                var isContainshua:boolean=false;
                for(var k=0;k<flower.length;k++){
                    if(HZMJMahjongAlgorithm1.IsContainsNumber(allCard,flower[k])){
                        isContainshua=true;
                    }
                }
                if(isContainshua){
                ...
                allCard.push(HZMJMahjongDef.gMahjongCard[i]);
                ...
                if (this.CheckIfCanHuCardArrayForNJMJ(allCard,laizi)){//////////此处加了一个南京麻将的判断
                    ...
                    //     //DaHuTye=HZMJMahjongAlgorithm1Lhh.GetHuTypeNJMJ(allCard,HZMJMahjongDef.gMahjongCard[i]);
                    //     if(DaHuTye.length>0){
                    //         tingCards.push(HZMJMahjongDef.gMahjongCard[i]);
                    //     }
                    // }
                    // else{
                        tingCards.push(HZMJMahjongDef.gMahjongCard[i]);
       ...
       public static GetTingCardArray(srcAry:Array<number>):Array<number>{
            ...
            HZMJMahjongAlgorithm1.sortCardAry(CdAry);
            ...
            for (var i = 0; i < HZMJMahjongDef.gMahjongCard.length; i++){
                ...
                if(HZMJMahjongAlgorithm1.CheckIfCanHuCardArray(allCard)){
                    tingCards.push(HZMJMahjongDef.gMahjongCard[i]);
                }
            }
            ...
            // var tingNormalCards:Array<number>=HZMJMahjongAlgorithm1.GetNormalTingCard(CdAry);
            // var tingSpecialCards:Array<number>=new Array<number>();
            // HZMJMahjongAlgorithm1.GetSpecialTingCard(CdAry,tingSpecialCards);


            // for(var i=0;i<tingNormalCards.length;i++){
            //     if(!HZMJMahjongAlgorithm1.IsContainsNumber(tingCards,tingNormalCards[i])){
            //         tingCards.push(tingNormalCards[i]);
            //     }
            // }
            // for(var i=0;tingSpecialCards.length;i++){
            //     if(!HZMJMahjongAlgorithm1.IsContainsNumber(tingCards,tingSpecialCards[i])){
            //         tingCards.push(tingSpecialCards[i]);
            //     }
            // }

            // HZMJMahjongAlgorithm1.sortCardAry(tingCards);
       ...
       public static CheckIfCanHuCardArray(srcAry:Array<number>):boolean{
            ...
            //检查普通胡牌
            if(HZMJMahjongAlgorithm1.IsHuNormalStruct(vSrc)){
                return true;
            }

            //检查特殊胡牌
            if(HZMJMahjongAlgorithm1.IsHuSpecialStruct(vSrc)){
                return true;
            }
            return false;
       }
       ...
       public static IsHuSpecialStruct(srcAry:Array<number>):boolean{
            ...
            if(HZMJMahjongAlgorithm1.IsHu13BuKao(srcAry)){
                console.log(`胡13不靠`);
                ishuss=true;
            }
            return ishuss;
        ...
        */
        public static IsHuSevenPairStruct(vSrc:Array<number>):boolean{
            //1、七对子结构，必须门清
            if (vSrc.length != HZMJMahjongDef.gCardCount_Active)
            {
                return false;
            }
        ...
        public static IsHu13BuKao(vSrc:Array<number>):boolean{
            ...
            for (var i = 0; i < vSrc.length - 1; i++)
            {
                if (HZMJMahjongAlgorithm1.GetMahjongColor(vSrc[i]) != HZMJMahjongAlgorithm1.GetMahjongColor(vSrc[i + 1]))
                {
                    i += 1;
                    continue;
                }
                if (HZMJMahjongAlgorithm1.GetMahjongColor(vSrc[i]) < 3)
                {
                    if (HZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i + 1]) - HZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i]) < 3)
                    {
                        return false;
                    }
                }
                ...
                {
                    if (HZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i + 1]) == HZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i]))
                    {
                        return false;
                    }
                }
            ...
            // var ziCardAry:Array<number> = HZMJMahjongAlgorithm1.GetDNXB();

            // HZMJMahjongAlgorithm1.AddRangeToAry(ziCardAry,HZMJMahjongAlgorithm1.GetZFB())
        ...
        */
        public static CheckIfCanTingCardArrayForNJMJ(srcAry:Array<number>,vectorTingCard:Array<number>=null):boolean{
            ...
            var flowerAry:Array<number>=HZMJMahjongAlgorithm1.GetFlowerCardAryHZMJ();//安庆麻将中有花牌不能胡,13不靠除外


             if(!this.CheckIfTing13BuKao(vSrc)){//不听13不靠，就不能有花牌
                for(var i=0;i<flowerAry.length;i++){
                    if(HZMJMahjongAlgorithm1.IsContainsNumber(vSrc,flowerAry[i])){
                        return false;
                    }
                }
            }
            ...
            //2、判断是否普通听牌
            if (HZMJMahjongAlgorithm1.CheckIfCanNormalTing(vSrc))
            {
                //获取普通听牌
                vTingNormal.splice(0,vTingNormal.length);
                //获取普通所听之牌
                vTingNormal=HZMJMahjongAlgorithm1.GetNormalTingCard(vSrc);
            }
            ...
            //合并两个听牌集并剔除重复
            //合并两个听牌集
            HZMJMahjongAlgorithm1.MergeVector(vTingNormal,vTingSpecial);
            //去除重复项
            HZMJMahjongAlgorithm1.RemoveRepeat(vTingNormal);
        ...
        private static CheckIfCanSpecialTing(vSrc: Array<number>): boolean {
            //听七对
            if(HZMJMahjongAlgorithm1.CheckIfTingSevenPair(vSrc)) {
                return true;
            }
            //十三烂
        ...
        */
        private static GetSpecialTingCard(vSrc:Array<number>,vectorTingCard:Array<number>):void
        {
            ...
            if(this.CheckIfTing13BuKao(vSrc)){
                ...
                HZMJMahjongAlgorithm1.Get13BuKaoTingCard(vSrc,tingAry);
        ...
        public static Get13BuKaoTingCard(vSrc:Array<number>, vectorTingCard:Array<number>):void
        {
            ...
            TingWanCard=HZMJMahjongAlgorithm1Lhh.Get029Wan();
            TingTongCard=HZMJMahjongAlgorithm1Lhh.Get029Tong();
            TingTiaoCard=HZMJMahjongAlgorithm1Lhh.Get029Tiao();
            TingZiCard=HZMJMahjongAlgorithm1Lhh.Get027Zi();
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                {
                    HZMJMahjongAlgorithm1Lhh.RemoveOneMember(TingZiCard,vSrc[i]);
                    continue;
                }
                else if (this.GetMahjongColor(vSrc[i]) == 0)
                {
                    HZMJMahjongAlgorithm1Lhh.RemoveMember(TingWanCard, vSrc[i]);
                }
                else if (this.GetMahjongColor(vSrc[i]) == 1)
                {
                    HZMJMahjongAlgorithm1Lhh.RemoveMember(TingTongCard, vSrc[i]);
                }
                else if (this.GetMahjongColor(vSrc[i]) == 2)
                {
                    HZMJMahjongAlgorithm1Lhh.RemoveMember(TingTiaoCard, vSrc[i]);
                }
            }
        ...
        //                     if (HZMJMahjongAlgorithm1.GetMahjongValue(vZhiCard[j]) == HZMJMahjongAlgorithm1.GetMahjongValue(all_zhi.zhi[i]))
        //                     {
        //                         isSame = true;
        //                         break;
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_wan.wan[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vWanCard[0])) >= 3)
        //                         {
        //                             vResult.push(all_wan.wan[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_wan.wan[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vWanCard[0])) >= 3 && Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_wan.wan[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vWanCard[1])) >= 3)
        //                         {
        //                             vResult.push(all_wan.wan[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_tong.tong[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vTongCard[0])) >= 3)
        //                         {
        //                             vResult.push(all_tong.tong[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_tong.tong[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vTongCard[0])) >= 3 && Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_tong.tong[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vTongCard[1])) >= 3)
        //                         {
        //                             vResult.push(all_tong.tong[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_tiao.tiao[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vTiaoCard[0])) >= 3)
        //                         {
        //                             vResult.push(all_tiao.tiao[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_tiao.tiao[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vTiaoCard[0])) >= 3 && Math.abs(HZMJMahjongAlgorithm1.GetMahjongValue(all_tiao.tiao[i]) - HZMJMahjongAlgorithm1.GetMahjongValue(vTiaoCard[1])) >= 3)
        //                         {
        //                             vResult.push(all_tiao.tiao[i]);
        //                         }
        //                     }
        ...
        private static GetFigureCardListByRemoveTriple(vectorSourceCard:Array<number>,vectorReturn:Array<Array<number>>):void{
            ...
            for (var i = 0; i < vectorSourceCard.length- 2; i++)
            {
                ...
                {
                    if (((HZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[k]) - HZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[i])) == 1) && (next1Idx == 0))//找到第一个(例:从233456678中根据3找到4)
                        next1Idx = k;
                    if (((HZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[k]) - HZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[i])) == 2) && (next2Idx == 0))//找到第一个(例:从233456678中根据3找到4)
                        next2Idx = k;
        ...
        public static getLaiZiNum(vSrc:Array<number>):number{
            ...
            for (var i = 0; i < vSrc.length; i++)
            {
                // if (vSrc[i] == HZMJ.ins.iclass.getHunCard())
                //     laiziNum++;
            }
            return laiziNum;
        }
        ...
        public static ChangeArrayToPairAndTripleForHuapai(vectorCard:Array<number>,laiziNum:number):boolean{
            ...
            for(var i=0;i<vectorCard.length;i++)
            {
                if(HZMJMahjongDef.gInvalidMahjongValue!=vectorCard[i])
        ...
        private static IsHuNormalStructHaveHun(vSrc:Array<number>):boolean{
            ...
            HZMJMahjongAlgorithm1.spiltHandCard(srcAry, vectorWan, vectorTong, vectorTiao, vectorZi);
            //3、得到各自的成组需赖子数
        ...
        private static Parse3ModelToTripleList(vSingleCard:Array<number>,vTriple:Array<clsParseTriple>):void
        {
            ...
            //3、开始解析
            if (HZMJMahjongAlgorithm1.GetMahjongColor(vSingleCard[0]) != HZMJMahjongDef.gMahjongColor_Zhi)//花牌,万，筒，条
            {
        ...
        public static SpiltHandCardByCardColor(srcAry:Array<number>, vectorWan:Array<number>, vectorTong:Array<number>, vectorTiao:Array<number>, vectorZhi:Array<number>):void
        {
            ...
            for (var i = 0; i < vSrc.length; i++)
            {
                ...
                {
                    case HZMJMahjongDef.gMahjongColor_Wan://万
                        {
                            vectorWan.push(vSrc[i]);
                            break;
                        }
                    case HZMJMahjongDef.gMahjongColor_Tong://筒
                        {
                            vectorTong.push(vSrc[i]);
                            break;
                        }
                    case HZMJMahjongDef.gMahjongColor_Tiao://条
                        {
                            vectorTiao.push(vSrc[i]);
                            break;
                        }
                    case HZMJMahjongDef.gMahjongColor_Zhi: //字
                        {
        ...
        //     if (HZMJMahjongAlgorithm1.IsHuSevenPairStruct(vSrc))//胡7对结构
        //     {
        //         return true;
        //     }
        ...
        public static GetACardWithOutLaiZi(vSrc:Array<number>):number{
            var temp=HZMJMahjongDef.gInvalidMahjongValue;
            // for(var i=0;i<vSrc.length;i++)
            // {
            //     if(vSrc[i]!=HZMJ.ins.iclass.getHunCard())
            //         return vSrc[i];
         ...
         * 获取安庆麻将花牌
         */
        public static GetFlowerCardAryHZMJ():Array<number>{
            var Ary:Array<number>=new Array<number>();
            Ary.push(0x31);
            Ary.push(0x35);
            Ary.push(0x36);
