...
import { allZhi } from "../ConstDef/LHZMJMahjongDef";
import { enTinType, LHZMJ,enFixedCardType, clsParseTriple, enHuCardType, enTripleType } from "../ConstDef/LHZMJMahjongDef";

import M_LHZMJView from "../M_LHZMJView";
import { LHZMJMahjongPattern } from "./LHZMJMahjongPattern";
import { LHZMJMahjongAlgorithm1Lhh } from "./LHZMJMahjongAlogorithmlhh";
import M_LHZMJClass from "../M_LHZMJClass";

const { ccclass, property } = cc._decorator;

	export class LHZMJMahjongAlgorithm1 {
        ...
        public static GetTwo2ModelTinCards(vectorCard1: Array<number>,vectorCard2: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard1[0]) < LHZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
            ...
            if(this.GetMahjongColor(vectorCard2[0]) < LHZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
        ...
        public static Get2ModelTinCards(vectorCard: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(vectorCard[0]) < LHZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //2张
                if(vectorCard.length == 2) {
        ...
        public static Get1ModelTinCards(cardVector: Array<number>): Array<number> {
            ...
            if(this.GetMahjongColor(cardVector[0]) < LHZMJMahjongDef.gMahjongColor_Zhi)//万,筒,条
            {
                //1张
    	...
    	public static getNeedChangeCard(handCard:Array<number>):Array<number>{
            ...
            if((null == handCard) || (handCard.length < 3)) {
    	      ...
    	      LHZMJMahjongAlgorithm1.spiltHandCard(handCard,wanCardAry,tongCardAry,tiaoCardAry,null);
        ...
        public static CheckIfTingShiSanLan(vSrc:Array<number>):boolean
        {
            ...
            LHZMJMahjongAlgorithm1.spiltHandCard(handCard,vWanCard,vTongCard,vTiaoCard,vZhiCard);

            //检查万筒条是否满足条件
            if (!LHZMJMahjongPattern.CheckValueBiggerTwo(vWanCard) || !LHZMJMahjongPattern.CheckValueBiggerTwo(vTongCard) || !LHZMJMahjongPattern.CheckValueBiggerTwo(vTiaoCard))
            {
                return false;
            }

            //检查字是否满足条件
            if (!LHZMJMahjongPattern.CheckZhiIsSame(vZhiCard))
            {
                return false;
            }
        ...
        //////////////////////////////////////////////////////////////////egret安庆麻将中的LHZMJMahjongAlgorithm1里面的代码//////////////////////////////////////////////////
        ...
        public static getColorNum(handCard: Array<number>):number{
            ...
            for(var i = 0;i < handCard.length; i++) {
                ...
                colorCard[LHZMJMahjongAlgorithm1.GetMahjongColor(handCard[i])] = 1;
            }
        ...
        public static CheckIsJiangCard(checkCard: number): boolean {
            if(LHZMJMahjongDef.gMahjongColor_Zhi == LHZMJMahjongAlgorithm1.GetMahjongColor(checkCard)) {
                return false;
            }

            if((2 == LHZMJMahjongAlgorithm1.GetMahjongValue(checkCard)) ||
                (5 == LHZMJMahjongAlgorithm1.GetMahjongValue(checkCard)) ||
                (8 == LHZMJMahjongAlgorithm1.GetMahjongValue(checkCard))) {
                return true;
            }
        ...
        public static CheckIs19Card(checkCard: number): boolean {
            ...
            if((1 == LHZMJMahjongAlgorithm1.GetMahjongValue(checkCard)) ||
                (9 == LHZMJMahjongAlgorithm1.GetMahjongValue(checkCard))) {
                return true;
            }
        ...
        public static GetMahjongColor(card:number):number{
            return (card & LHZMJMahjongDef.gCardMask_color) >> 4;
        }
        /**
         * 取花色数值,0x00万,0x10筒,0x20条，0x30字
         * */
        public static GetMahjongColorValue(card:number):number{
            return (card & LHZMJMahjongDef.gCardMask_color);
        }
        /**
         * 取麻将牌值,1~9,一万==一筒==一条
         * */
        public static GetMahjongValue(card):number{
            return (card & LHZMJMahjongDef.gCardMask_value);
        }
        /**
         * 取麻将牌逻辑数值,取牌逻辑值:万<筒<条<字<花
         * */
        public static GetMahjongLogicValue(card):number{
            return LHZMJMahjongAlgorithm1.GetMahjongColor(card) * 10 + LHZMJMahjongAlgorithm1.GetMahjongValue(card);
        }
        ...
        public static CheckVoteRight_Peng(voteRight:number):boolean{
            return (voteRight & LHZMJMahjongDef.gVoteRightMask_Peng) > 0;
           //return (voteRight == LHZMJMahjongDef.gVoteRightMask_Peng);
        }
        /**
         * 检查是否可以杠
         * */
        public static CheckVoteRight_Gang(voteRight: number): boolean {
            return (voteRight & LHZMJMahjongDef.gVoteRightMask_Gang) > 0;
         // return (voteRight == LHZMJMahjongDef.gVoteRightMask_Gang);
        }
        /**
         * 检查是否可以胡
         * */
        public static CheckVoteRight_Hu(voteRight: number): boolean {
            return (voteRight & LHZMJMahjongDef.gVoteRightMask_Hu) > 0;
         // return (voteRight == LHZMJMahjongDef.gVoteRightMask_Hu);
        }
         /**
         * 检查是否可以听
         * */
        public static CheckVoteRight_Ting(voteRight: number): boolean {
            ...
            return (voteRight == LHZMJMahjongDef.gVoteRightMask_Ting);
        ...
        //     return (voteRight & LHZMJMahjongDef.gVoteRightMask_Chi) > 0;
        // }
        ...
        public static sortCardAry(cardAry:Array<number>):void{
            ...
            //         if(cardAry[i]!=LHZMJMahjongDef.LaiZi&&(cardAry[j]==LHZMJMahjongDef.LaiZi||cardAry[i] > cardAry[j])){
...
// }
        ...
        public static checkHaveColor(handCard: Array<number>,color:number):boolean{
            for(var i:number=0; i<handCard.length; i++){
                if(color == LHZMJMahjongAlgorithm1.GetMahjongColor(handCard[i])){
                    return true;
                }
            }
            return false;
        ...
        {
            var num:number = 0;
            if (cardAry == null || cardAry.length == 0 || card == LHZMJMahjongDef.gInvalidMahjongValue)
            {
                return num;
            }
            for(var i=0;i<cardAry.length;i++){
        ...
        */
        ...
        public static spiltHandCard(handCard:Array<number>,wan:Array<number>,tong:Array<number>,tiao:Array<number>,zhi:Array<number>):void{
            ...
            for(var i:number=0; i<handCard.length; i++){
                if(LHZMJMahjongDef.gInvalidMahjongValue != handCard[i]){
                    switch(LHZMJMahjongAlgorithm1.GetMahjongColor(handCard[i])){
                        case LHZMJMahjongDef.gMahjongColor_Wan:{
                            if(null != wan){
                                wan.push(handCard[i]);
                            }
                            break;
                        }
                        case LHZMJMahjongDef.gMahjongColor_Tong:{
                            if(null != tong){
                                tong.push(handCard[i]);
                            }
                            break;
                        }
                        case LHZMJMahjongDef.gMahjongColor_Tiao:{
                            if(null != tiao){
                                tiao.push(handCard[i]);
                            }
                            break;
                        }
                        case LHZMJMahjongDef.gMahjongColor_Zhi:{
                            if(null != zhi){
                                zhi.push(handCard[i]);
                            }
                        }
        ...
        public static IsHunYiSe(Ary:Array<number>):boolean{
            ...
            var colorfirst = LHZMJMahjongDef.gInvalidMahjongValue;
            ...
            if(colorfirst== LHZMJMahjongDef.gInvalidMahjongValue)//如果混一色判断出现问题的话，那么很有可能是这个地方出了问题(关键是，只有东南西北，没有万筒条，算不算混一色)
            {
                return isqys;
            }
        ...
        public static GetTingCardArrayHaveHun(srcAry:Array<number>,laizi:number):Array<number>{
            ...
            {
                if(this.GetCardNumInCardAry(srcAry,LHZMJMahjongDef.gMahjongCard[i])==4){//这个判断是，如果手上有4张牌则不提示胡此牌
                    continue;
                }
                ...
                var flower:Array<number> =LHZMJMahjongAlgorithm1.GetFlowerCardAryLHZMJ();//手上有花牌不能胡
                var isContainshua:boolean=false;
                for(var k=0;k<flower.length;k++){
                    if(LHZMJMahjongAlgorithm1.IsContainsNumber(allCard,flower[k])){
                        isContainshua=true;
                    }
                }
                if(isContainshua){
                ...
                if (this.CheckIfCanHuCardArrayForNJMJ(allCard,laizi)){//////////此处加了一个南京麻将的判断
                    ...
                    //     //DaHuTye=LHZMJMahjongAlgorithm1Lhh.GetHuTypeNJMJ(allCard,LHZMJMahjongDef.gMahjongCard[i]);
                    //     if(DaHuTye.length>0){
       ...
       public static GetTingCardArray(srcAry:Array<number>):Array<number>{
            ...
            LHZMJMahjongAlgorithm1.sortCardAry(CdAry);
            ...
            for (var i = 0; i < LHZMJMahjongDef.gMahjongCard.length; i++){
                ...
                if(LHZMJMahjongAlgorithm1.CheckIfCanHuCardArray(allCard)){
                    tingCards.push(LHZMJMahjongDef.gMahjongCard[i]);
                }
            }
            ...
            // var tingNormalCards:Array<number>=LHZMJMahjongAlgorithm1.GetNormalTingCard(CdAry);
            // var tingSpecialCards:Array<number>=new Array<number>();
            // LHZMJMahjongAlgorithm1.GetSpecialTingCard(CdAry,tingSpecialCards);


            // for(var i=0;i<tingNormalCards.length;i++){
            //     if(!LHZMJMahjongAlgorithm1.IsContainsNumber(tingCards,tingNormalCards[i])){
            //         tingCards.push(tingNormalCards[i]);
            //     }
            // }
            // for(var i=0;tingSpecialCards.length;i++){
            //     if(!LHZMJMahjongAlgorithm1.IsContainsNumber(tingCards,tingSpecialCards[i])){
            //         tingCards.push(tingSpecialCards[i]);
            //     }
            // }

            // LHZMJMahjongAlgorithm1.sortCardAry(tingCards);
       ...
       public static CheckIfCanHuCardArray(srcAry:Array<number>):boolean{
            ...
            //检查普通胡牌
            if(LHZMJMahjongAlgorithm1.IsHuNormalStruct(vSrc)){
                return true;
            }

            //检查特殊胡牌
            if(LHZMJMahjongAlgorithm1.IsHuSpecialStruct(vSrc)){
                return true;
            }
            return false;
       }
       ...
       public static IsHuSpecialStruct(srcAry:Array<number>):boolean{
            ...
            if(LHZMJMahjongAlgorithm1.IsHu13BuKao(srcAry)){
                console.log(`胡13不靠`);
                ishuss=true;
            }
            return ishuss;
        ...
        */
        ...
        public static IsHu13BuKao(vSrc:Array<number>):boolean{
            ...
            for (var i = 0; i < vSrc.length - 1; i++)
            {
                if (LHZMJMahjongAlgorithm1.GetMahjongColor(vSrc[i]) != LHZMJMahjongAlgorithm1.GetMahjongColor(vSrc[i + 1]))
                {
                    i += 1;
                    continue;
                }
                if (LHZMJMahjongAlgorithm1.GetMahjongColor(vSrc[i]) < 3)
                {
                    if (LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i + 1]) - LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i]) < 3)
                    {
                        return false;
                    }
                }
                ...
                {
                    if (LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i + 1]) == LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vSrc[i]))
                    {
                        return false;
                    }
                }
            ...
            // var ziCardAry:Array<number> = LHZMJMahjongAlgorithm1.GetDNXB();

            // LHZMJMahjongAlgorithm1.AddRangeToAry(ziCardAry,LHZMJMahjongAlgorithm1.GetZFB())
        ...
        */
        public static CheckIfCanTingCardArrayForNJMJ(srcAry:Array<number>,vectorTingCard:Array<number>=null):boolean{
            ...
            var flowerAry:Array<number>=LHZMJMahjongAlgorithm1.GetFlowerCardAryLHZMJ();//安庆麻将中有花牌不能胡,13不靠除外


             if(!this.CheckIfTing13BuKao(vSrc)){//不听13不靠，就不能有花牌
                for(var i=0;i<flowerAry.length;i++){
                    if(LHZMJMahjongAlgorithm1.IsContainsNumber(vSrc,flowerAry[i])){
                        return false;
                    }
                }
            }
            ...
            //2、判断是否普通听牌
            if (LHZMJMahjongAlgorithm1.CheckIfCanNormalTing(vSrc))
            {
                //获取普通听牌
                vTingNormal.splice(0,vTingNormal.length);
                //获取普通所听之牌
                vTingNormal=LHZMJMahjongAlgorithm1.GetNormalTingCard(vSrc);
            }
            ...
            //合并两个听牌集并剔除重复
            //合并两个听牌集
            LHZMJMahjongAlgorithm1.MergeVector(vTingNormal,vTingSpecial);
            //去除重复项
            LHZMJMahjongAlgorithm1.RemoveRepeat(vTingNormal);
        ...
        private static CheckIfCanSpecialTing(vSrc: Array<number>): boolean {
            //听七对
            if(LHZMJMahjongAlgorithm1.CheckIfTingSevenPair(vSrc)) {
                return true;
            }
            //十三烂
        ...
        */
        private static GetSpecialTingCard(vSrc:Array<number>,vectorTingCard:Array<number>):void
        {
            ...
            if(this.CheckIfTing13BuKao(vSrc)){
                ...
                LHZMJMahjongAlgorithm1.Get13BuKaoTingCard(vSrc,tingAry);
        ...
        public static Get13BuKaoTingCard(vSrc:Array<number>, vectorTingCard:Array<number>):void
        {
            ...
            TingWanCard=LHZMJMahjongAlgorithm1Lhh.Get029Wan();
            TingTongCard=LHZMJMahjongAlgorithm1Lhh.Get029Tong();
            TingTiaoCard=LHZMJMahjongAlgorithm1Lhh.Get029Tiao();
            TingZiCard=LHZMJMahjongAlgorithm1Lhh.Get027Zi();
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                {
                    LHZMJMahjongAlgorithm1Lhh.RemoveOneMember(TingZiCard,vSrc[i]);
                    continue;
                }
                else if (this.GetMahjongColor(vSrc[i]) == 0)
                {
                    LHZMJMahjongAlgorithm1Lhh.RemoveMember(TingWanCard, vSrc[i]);
                }
                else if (this.GetMahjongColor(vSrc[i]) == 1)
                {
                    LHZMJMahjongAlgorithm1Lhh.RemoveMember(TingTongCard, vSrc[i]);
                }
                else if (this.GetMahjongColor(vSrc[i]) == 2)
                {
                    LHZMJMahjongAlgorithm1Lhh.RemoveMember(TingTiaoCard, vSrc[i]);
                }
            }
        ...
        //                     if (LHZMJMahjongAlgorithm1.GetMahjongValue(vZhiCard[j]) == LHZMJMahjongAlgorithm1.GetMahjongValue(all_zhi.zhi[i]))
        //                     {
        //                         isSame = true;
        //                         break;
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_wan.wan[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vWanCard[0])) >= 3)
        //                         {
        //                             vResult.push(all_wan.wan[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_wan.wan[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vWanCard[0])) >= 3 && Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_wan.wan[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vWanCard[1])) >= 3)
        //                         {
        //                             vResult.push(all_wan.wan[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_tong.tong[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vTongCard[0])) >= 3)
        //                         {
        //                             vResult.push(all_tong.tong[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_tong.tong[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vTongCard[0])) >= 3 && Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_tong.tong[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vTongCard[1])) >= 3)
        //                         {
        //                             vResult.push(all_tong.tong[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_tiao.tiao[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vTiaoCard[0])) >= 3)
        //                         {
        //                             vResult.push(all_tiao.tiao[i]);
        //                         }
        //                     }
        ...
        //                     for (var i:number = 0; i < 9; i++)
        //                     {
        //                         if (Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_tiao.tiao[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vTiaoCard[0])) >= 3 && Math.abs(LHZMJMahjongAlgorithm1.GetMahjongValue(all_tiao.tiao[i]) - LHZMJMahjongAlgorithm1.GetMahjongValue(vTiaoCard[1])) >= 3)
        //                         {
        //                             vResult.push(all_tiao.tiao[i]);
        //                         }
        //                     }
        ...
        private static GetFigureCardListByRemoveTriple(vectorSourceCard:Array<number>,vectorReturn:Array<Array<number>>):void{
            ...
            for (var i = 0; i < vectorSourceCard.length- 2; i++)
            {
                ...
                {
                    if (((LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[k]) - LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[i])) == 1) && (next1Idx == 0))//找到第一个(例:从233456678中根据3找到4)
                        next1Idx = k;
                    if (((LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[k]) - LHZMJMahjongAlgorithm1.GetMahjongLogicValue(vectorSourceCard[i])) == 2) && (next2Idx == 0))//找到第一个(例:从233456678中根据3找到4)
                        next2Idx = k;
        ...
        public static getLaiZiNum(vSrc:Array<number>):number{
            ...
            for (var i = 0; i < vSrc.length; i++)
            {
                // if (vSrc[i] == LHZMJ.ins.iclass.getHunCard())
                //     laiziNum++;
            }
            return laiziNum;
        }
        ...
        public static ChangeArrayToPairAndTripleForHuapai(vectorCard:Array<number>,laiziNum:number):boolean{
            ...
            for(var i=0;i<vectorCard.length;i++)
            {
                if(LHZMJMahjongDef.gInvalidMahjongValue!=vectorCard[i])
        ...
        public static SpiltHandCardByCardColor(srcAry:Array<number>, vectorWan:Array<number>, vectorTong:Array<number>, vectorTiao:Array<number>, vectorZhi:Array<number>):void
        {
            ...
            for (var i = 0; i < vSrc.length; i++)
            {
                ...
                {
                    case LHZMJMahjongDef.gMahjongColor_Wan://万
                        {
                            vectorWan.push(vSrc[i]);
                            break;
                        }
                    case LHZMJMahjongDef.gMahjongColor_Tong://筒
                        {
                            vectorTong.push(vSrc[i]);
                            break;
                        }
                    case LHZMJMahjongDef.gMahjongColor_Tiao://条
                        {
                            vectorTiao.push(vSrc[i]);
                            break;
                        }
                    case LHZMJMahjongDef.gMahjongColor_Zhi: //字
                        {
        ...
        //     if (LHZMJMahjongAlgorithm1.IsHuSevenPairStruct(vSrc))//胡7对结构
        //     {
        //         return true;
        //     }
        ...
        public static GetACardWithOutLaiZi(vSrc:Array<number>):number{
            var temp=LHZMJMahjongDef.gInvalidMahjongValue;
            // for(var i=0;i<vSrc.length;i++)
            // {
            //     if(vSrc[i]!=LHZMJ.ins.iclass.getHunCard())
            //         return vSrc[i];
         ...
         * 获取安庆麻将花牌
         */
        public static GetFlowerCardAryLHZMJ():Array<number>{
            var Ary:Array<number>=new Array<number>();
            Ary.push(0x31);
            Ary.push(0x35);
            Ary.push(0x36);
