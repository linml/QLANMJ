import { LHZMJ, LHZMJSoundDef } from "../ConstDef/LHZMJMahjongDef";
...
@ccclass
export default class LHZMJ_SZAni extends cc.Component {
    ...
    public playSZ(sz1:number,sz2:number,msgcode:number):void{   
        ...
        // //LHZMJ.ins.iclass.playMJSound(LHZMJSoundDef.sound_sz);
    ...
    private szComplete():void{
        ...
        if(++this._aniCompleteNum >= 2){
            ...
            console.log("骰子完毕");    
            this.node.dispatchEvent(new LHZMJEvent(this._msgCode));  
        }
    }
    public StopAni():void{
        this.unscheduleAllCallbacks();
