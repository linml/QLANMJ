...
import { TingCardTip, LHZMJ } from "../ConstDef/LHZMJMahjongDef";
 ...
 * */
@ccclass
export default class LHZMJ_SingleTingCardTip extends cc.Component {
    ...
    // public LHZMJ_SingleTingCardTip(){
    ...
    protected setTexture(): void {
        cc.log("显示单个听牌！！！");
        //var sFrame = new cc.SpriteFrame(M_LHZMJClass.ins.getMahjongResName(this._data.tingCard));
        //this.img_cardColor.spriteFrame = sFrame;
        cc.log(`听的牌为：${this._data.tingCard}`);
        // let url = LHZMJ.ins.iclass.getMahjongResName(this._data.tingCard);
