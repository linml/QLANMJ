...
class DrawMoney extends Base {
	...
	/**
	 * [getOnvertedMoney 金额转换钻石]
	 * @Author   李爽
	 * @DateTime 2018-08-23T17:15:04+0800
	 * @param    [type]                   $diamond  [description]
	 * @param    [type]                   $discount [description]
	 * @return   [type]                             [description]
	 */
	public static function getOnvertedMoney($diamond,$discount){
		if(empty($diamond)||empty($discount)) return;
		return 0 + floor(($diamond/10)*(1-$discount));
	}
