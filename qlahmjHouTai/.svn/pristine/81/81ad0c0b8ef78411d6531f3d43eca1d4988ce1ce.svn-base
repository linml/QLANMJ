    ...
    <div class="col-xs-12">
        ...
        <form action="" method="POST" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="playerid" id="playerid" value="<{$_REQUEST.playerid}>" required="true" maxlength='10' placeholder="请输入玩家ID！"> 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="agentid" id="agentid" value="<{$_REQUEST.agentid}>" maxlength='10' placeholder="请输入代理ID！">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="real_name" id="real_name" value="<{$_REQUEST.real_name}>" required="true" placeholder="请输入姓名！" > 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="mobile" id="mobile" value="<{$_REQUEST.mobile}>" required="true" maxlength='11' placeholder="请输入手机号！"> 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="wechat" id="wechat" value="<{$_REQUEST.wechat}>" required="true" placeholder="请输入微信号！" > 
                </div>
            </div>
           ...
           <!--  <div class="form-group">
               ...
               <div class="col-sm-9">
                   <input type="text" name="verify_code" id="code" value="<{$_REQUEST.user_name}>" autocomplete="off" required="true" placeholder="输入验证码"> 
