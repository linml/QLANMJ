...
<div class="row" style="margin:10px 0">
	<div style="float: left;font-weight: 700;">待处理提现:<{$pendAndProc.processed|default:0}>元</div>
	<div style="float: left;margin-left:50px;font-weight: 700;">已处理提现:<{$pendAndProc.pending|default:0}>元</div>
</div>
