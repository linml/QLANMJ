<?php /* Smarty version Smarty-3.1.15, created on 2018-08-29 19:58:02
		...
		<form action="" method="GET" class="form-inline" role="form">
			...
			<div class="form-group">
					...
					<select name="type" id='ga_type'>
						<option value="1" selected>玩家昵称</option>
						<option value="2">玩家ID</option>
						<option value="3">代理ID</option>
						<option value="4">代理昵称</option>
					</select>
				</div>
					<input type="text" id="id"  name="uid" value="" placeholder="请输入"> 
...
/<?php echo $_smarty_tpl->tpl_vars['val']->value['nickname'];?>
					...
					<td><?php echo $_smarty_tpl->tpl_vars['val']->value['diamond'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['val']->value['gold'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['val']->value['qidou'];?>
</td>
...
','<?php echo $_smarty_tpl->tpl_vars['val']->value['nickname'];?>
','<?php echo $_smarty_tpl->tpl_vars['val']->value['agentid'];?>
...
<script type="text/javascript">
	...
	$('#tabClose').click(function(){
		var status = $('#c_status input:radio:checked').val()
		var userid = $('#c_guId').val()
		var oldStatus = $('#c_status input:hidden').val()
