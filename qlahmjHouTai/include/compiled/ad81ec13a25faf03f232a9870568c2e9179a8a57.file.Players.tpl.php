<?php /* Smarty version Smarty-3.1.15, created on 2018-09-13 12:01:11
            ...
            <div class="N_RecordTop wp_94 mgTp3A">
                <div class="clearfix">
                    <form action="" method="POST">
                        <div class="clearfix">
                             <input type="text" class="N_agentIpt MyAgent_input fl" placeholder="请输入玩家ID"  id="userid" min="0" name="userid" value="<?php echo $_smarty_tpl->tpl_vars['_REQUEST']->value['userid'];?>
">
