<?php /* Smarty version Smarty-3.1.15, created on 2018-09-14 11:37:38
         compiled from "F:\project\qlahmjHouTai\include\template\agentcenter\toDrawmoney.tpl" */ ?>
<?php /*%%SmartyHeaderCode:128475b616cdcd81e00-37143166%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a72a6d3438e4e2894c285c98b0de0ac8781e37ea' => 
    array (
      0 => 'F:\\project\\qlahmjHouTai\\include\\template\\agentcenter\\toDrawmoney.tpl',
      1 => 1536212458,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '128475b616cdcd81e00-37143166',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_5b616cdcdc8311_68557100',
  'variables' => 
  array (
    'agentInfo' => 0,
    'discount' => 0,
...
<?php if ($_valid && !is_callable('content_5b616cdcdc8311_68557100')) {function content_5b616cdcdc8311_68557100($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("simple_header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
        ...
        <div class="N_bg">
            <div class="N_agentTop clearfix mgTp1A" style="background:url(/assets/images/agentCenter/bg9.png) no-repeat center top/100% auto;">
                <div class="C_wh50 floatL pd30">
                  <p class="ft25 c_fff"><?php echo $_smarty_tpl->tpl_vars['agentInfo']->value['diamond'];?>
个</p>
                  <p class="c_fff">所拥有钻石</p>
                </div>
                <div class="C_wh50 floatL pd30">
                  <p class="ft25 c_fff"><?php echo $_smarty_tpl->tpl_vars['agentInfo']->value['rmb'];?>
</p>
          ...
          <ul>
            <li class="relative C_wh bgc_fff mgb3 borderR5">
              ...
              <div class="absolute f_return left40 top50"><?php echo $_smarty_tpl->tpl_vars['discount']->value*100;?>
%</div>
              <div class="absolute left26 top46" id='addDiscountDiamond'>
                <img src="/assets/images/agentCenter/add.svg" width="25" height="25">
              </div>
              <span class="absolute inputbox left4 top43" type="" name="money" id="money" style="text-indent: 6px">10</span>
...
<script>
  $(function(){
      ...
      $('#addDiscountDiamond').click(function(){
        var money =  parseInt(10) + parseInt($("#money").text()?$("#money").text():0);
        if(!money) return;
