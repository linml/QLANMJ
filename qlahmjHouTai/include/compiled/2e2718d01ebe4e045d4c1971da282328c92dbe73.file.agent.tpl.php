<?php /* Smarty version Smarty-3.1.15, created on 2018-10-10 12:56:40
         compiled from "F:\project\QLAHMJ\qlahmjHouTai\include\template\agent\agent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:170605bbd7878d4c8f9-29866596%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2e2718d01ebe4e045d4c1971da282328c92dbe73' => 
    array (
      0 => 'F:\\project\\QLAHMJ\\qlahmjHouTai\\include\\template\\agent\\agent.tpl',
      1 => 1538044603,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '170605bbd7878d4c8f9-29866596',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbd7878e42ab3_29961630',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbd7878e42ab3_29961630')) {function content_5bbd7878e42ab3_29961630($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'F:\\project\\QLAHMJ\\qlahmjHouTai\\include\\config/../../include/lib/Smarty/plugins\\modifier.truncate.php';
...
"><?php echo $_smarty_tpl->tpl_vars['val']->value['real_name'];?>
</option>
				<?php } ?>
			</select>
...
?>
				<tr>
					...
					<td >(<?php echo $_smarty_tpl->tpl_vars['agent']->value['buserid'];?>
)<?php echo $_smarty_tpl->tpl_vars['agent']->value['bnickname'];?>
</td>
					...
					<td><?php echo round($_smarty_tpl->tpl_vars['agent']->value['diamond']);?>
</td>
					...
					<td>锁定</td>
					<?php }?>
					<td><?php echo $_smarty_tpl->tpl_vars['agent']->value['adminrealname'];?>
</td>
						<td>
							<button class="" onclick="sendmoneyInfo('<?php echo $_smarty_tpl->tpl_vars['agent']->value['agentid'];?>
')">划拨</button>
							<button class="" onclick ="showagentInfo('<?php echo $_smarty_tpl->tpl_vars['agent']->value['agentid'];?>
')" >详情</button>
						</td>
				</tr>
				<?php } ?>
...
<script type="text/javascript">
	...
	{	
		...
		var admins = <?php echo $_smarty_tpl->tpl_vars['showInfoAdminList']->value;?>
		...
		$.ajax({
			...
			success:function(data){
				...
				$('#a_diragent').html('<input type="text" name="parentid" value="('+data.cuserid+')'+data.cnickname+'" style="border:0 none;background-color:transparent;" disabled><button id="changeDirAgent" style="margin-left:15%">修改上级</button>')
