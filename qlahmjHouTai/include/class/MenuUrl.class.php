...
class MenuUrl extends Base {
	...
	private static $table_name = 'pigcms_menu_url';
	// 查询字段
	private static $columns = 'menu_id, menu_name, menu_url, module_id, is_show, online, menu_type,shortcut_allowed,menu_desc,father_menu';	
	...
	/**
	 * [getMenuByRole 通过角色获取菜单URL]
	 * @Author   李爽
	 * @DateTime 2018-07-26T15:09:07+0800
	 * @param    [type]                   $user_role [角色数据]
	 * @param    integer                  $online    [在线状态]
	 * @return   [type]                              [返回菜单集]
	 */
	...
	/**
	 * [getListByModuleId 通过moduleID 获取列表菜单]
	 * @Author   李爽
	 * @DateTime 2018-07-26T15:15:09+0800
	 * @param    [type]                   $module_id [模块编号]
	...
	/**
	 * [getMenuByUrl 通过URL获取菜单]
	 * @Author   李爽
	 * @DateTime 2018-07-26T15:27:16+0800
	 * @param    [type]                   $url [url]
	...
	public static function clearSession(){
		//STools::log("clearSession in menu");
