...
class ErrorMessage {
	...
	const Confirm_Password_Mistake ="确认密码错误";
	const AGENT_UID_CONFLICT ="玩家ID冲突";
	const TUSER_NOT_EXIST ="玩家ID不存在";
	const AGENT_EXIST ="代理ID存在";
	const AGENT_NOT_EXIST ="玩家ID不存在";
	const TUSER_EXIST ="玩家ID存在";
	const SUCCESS_SELL_GEMS_NUMBER ="转卡成功";
	const FAIL_ISTOP_BEHIN ="待开通玩家等级高于上级代理等级！";
	const PALYER_IS_AGENT = '此玩家已是代理！';
	const PALYER_TEL_IS_EXIST = '玩家手机号码已被注册！';
	const PALYER_WACHAT_IS_EXIST = '玩家微信帐号已被注册！';
}