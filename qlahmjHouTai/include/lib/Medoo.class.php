...
class Medoo{
	...
	public function insert($table, $data)
	{
		...
		// var_dump('INSERT INTO ' . $table . ' (' . $keys . ') VALUES (' . $this->data_implode(array_values($values), ',') . ')');
		// exit();
	...
	public function update($table, $data, $where = null)
	{
		...
		// echo 'UPDATE ' . $table . ' SET ' . implode(',', $fields) . $this->where_clause($where);
		// STools::log('UPDATE ' . $table . ' SET ' . implode(',', $fields) . $this->where_clause($where));
		// STools::log('\n');
	...
	{	
		...
		// exit('DELETE FROM ' . $table . $this->where_clause($where));
